...
- v0.118 隔离预发版本 `83670b5e-20260811T144740Z` 已关闭 force-mock：服务 active、`NRestarts=0`，3 模板通过；AIStar 在线 requirements 返回 `authorizationVideoRequired=false`、形象硬门 5 秒、声音端上硬门 3 秒。自动化没有创建任何计费任务，下一步由用户本人从军师预发真机包提交素材。
