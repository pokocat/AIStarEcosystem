...
> **文档状态**：**M1 服务端、石榴官方单视频 Avatar 创建/可选声音增强/多数字人选择与多段 ffmpeg 总装已落地；文案句与视觉镜头分层，模板固定视频可后台配置，V2 克隆音色统一驱动数字人与 b-roll，逐句字幕、默认关闭的可选 AI 水印与音画质量门已启用；本人素材质量实测、媒体审核与真实代发未上线**。
