...
- v0.116 隔离预发版本 `458246e1-20260811T124030Z` 已关闭 force-mock：服务 active、`NRestarts=0`，3 模板、requirements 与石榴只读权益探针通过；账户仍为 12000 点、0 分身、0 音色，自动化没有创建任何计费任务。下一步由用户本人从军师预发真机包提交素材。
