...
| [`docs/clip-avatar-video-plan.md`](clip-avatar-video-plan.md) | **`clip` 口播视频线**（军师小程序分包） | v0.129：作品回传开始/完成时间，删除会取消活跃任务并进入 30 天回收；默认关闭的可选 AI 水印、多数字人、声音复用、后台固定视频、逐句字幕、多段总装与音画质量门保持不变（last-reviewed 2026-08-11）。 |
