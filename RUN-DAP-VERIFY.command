...
# 实际逻辑全部在 apps/web-aiavatar/scripts/dap-verify.sh，本文件只是 Finder 可双击的入口。
cd "$(dirname "$0")"
...
PROFILE=${PROFILE:-mysql} AGNES=${AGNES:-real} bash apps/web-aiavatar/scripts/dap-verify.sh
RC=$?
echo ""
