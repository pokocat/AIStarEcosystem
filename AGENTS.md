...
| **统一账号中心** | ✅ P1+P2（v0.149，未上线） | 独立仓库 `pokocat/aibuzz-id`（OIDC，`id.aibuzz.cn`；初版代码曾在本仓 `apps/id-server` 孵化，v0.149 同日抽离）+ 本仓全部应用接入；P3 军师 / P4 公社 / P5 收尾见 [`docs/unified-identity-plan.md`](docs/unified-identity-plan.md) §9 |
...
**未完成事项**：小程序的 wx.subscribeMessage / WebSocket（v0.6+）、统一账号中心 P2–P5 接入（`docs/unified-identity-plan.md`）、K8s ACK（Phase 6）。
