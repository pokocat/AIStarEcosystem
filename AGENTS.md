...
- 六个新 web app: **web-music**（3010）/ **web-drama**（3011）/ **web-celebrity**（3012）/ **web-aiavatar**（3013，数字资产平台 · 六类资产）/ **web-star**（3014，明星商务工作台）/ **web-ipstudio**（3015，AI IP 工作台 · 桌面无限画布，共用 aiavatar 开通）
...
│   ├── web-aiavatar/       # AiAvatar 数字资产平台（六类资产 · 移动端 H5/小程序 SPA）— port 3013
│   ├── web-star/           # 明星商务工作台（明星/经纪团队审核中枢，浅色主题）— port 3014
│   └── web-ipstudio/       # AI IP 工作台（照片 + 内置工作流 → 一致的 IP 形象组；React Flow 画布）— port 3015
...
pnpm dev:ipstudio                             # web-ipstudio — http://localhost:3015（默认 mock；真后端见 apps/web-ipstudio/README.md）
...
pnpm --filter @ai-star-eco/web-ipstudio build         # AI IP 工作台生产构建
...
| **AI IP 工作台** | `apps/web-ipstudio/` | 3015 | [`apps/web-ipstudio/PRODUCT.md`](apps/web-ipstudio/PRODUCT.md) | [`docs/ip-studio-plan.md`](docs/ip-studio-plan.md) | `/projects`（桌面无限画布；共用 aiavatar 开通，`X-App-Code: aiavatar`） |
