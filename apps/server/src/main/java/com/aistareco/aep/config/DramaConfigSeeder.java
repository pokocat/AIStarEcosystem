...
public class DramaConfigSeeder implements CommandLineRunner {
    ...
    /** 角色定妆三视图（正/侧/背）生成单次积分（v0.85 视觉一致性）。 */
    public static final String KEY_PORTRAIT = "drama.credit.portrait";
    ...
    public void run(String... args) {
        ...
        configs.seedIfAbsent(KEY_PORTRAIT, IntNode.valueOf(6), "短剧 · 角色定妆三视图（正/侧/背）生成单次积分");
