...
import { setMediaBlob } from "@/canvas-bridge/file-storage";
import { setImageBlob } from "@/canvas-bridge/image-storage";
...
import { hasAgentUrlBootstrap } from "@/canvas-bridge/agent-url";
...
export default function CanvasPage() {
    ...
    const enterProject = (id: string) => {
        ...
        (Boolean(agentHash)  ? router.replace(`/canvas/${id}${agentQuery}${agentHash}`) : router.push(`/canvas/${id}${agentQuery}${agentHash}`));
    };
