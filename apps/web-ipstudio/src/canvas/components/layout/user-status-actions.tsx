...
import { changeAppLocale, type AppLocale } from "@/canvas-bridge/i18n";
    ...
    return (
        <div className="inline-flex shrink-0 items-center gap-1">
            ...
            <Tooltip title={languageLabel} mouseEnterDelay={0.2}>
                <button type="button" className={`${naturalIconClass} text-[11px] font-semibold tracking-tight`} style={iconStyle} onClick={() => void changeAppLocale("zh-CN") /* 本仓中文单语，见 canvas-bridge/i18n.ts */} aria-label={languageLabel}>
                    {locale === "zh-CN" ? "中" : "EN"}
                </button>
            </Tooltip>
