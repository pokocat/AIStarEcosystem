...
export const REVENUE_SOURCES: RevenueSource[] = [
  ...
  { name: "NFT 销售",   value: 18, color: "#ec4899" },
...
export const TRANSACTIONS: Transaction[] = [
  { id: "t1", source: "Spotify 版税结算",   amount:   8_200, date: "2026-04-14", status: "completed",  type: "income",        userId: "u-001" },
  { id: "t2", source: "提现至银行卡",        amount: -20_000, date: "2026-04-12", status: "completed",  type: "withdrawal",    userId: "u-001" },
  { id: "t3", source: "NFT #287 售出",       amount:   4_800, date: "2026-04-10", status: "completed",  type: "income",        userId: "u-001" },
  { id: "t4", source: "品牌代言 · 某科技",   amount:  35_000, date: "2026-04-08", status: "completed",  type: "income",        userId: "u-002" },
  { id: "t5", source: "YouTube Ad 分成",     amount:   3_200, date: "2026-04-05", status: "processing", type: "income",        userId: "u-002" },
  ...
  { id: "t8", source: "Bilibili 创作激励",   amount:   2_100, date: "2026-03-28", status: "pending",    type: "income",        userId: "u-002" },
  { id: "t9", source: "入门包充值",          amount:   5_000, date: "2026-02-15", status: "completed",  type: "recharge",      userId: "u-003" },
  { id: "t10",source: "License 核销入账",    amount:   1_000, date: "2026-01-22", status: "completed",  type: "license_grant", userId: "u-003" },
