...
export const CREDIT_PACKS: CreditPack[] = [
  { id: "pack-starter",  code: "starter",    name: "入门包",  credits: 1_000,    priceCents: 9_900,    highlights: ["1,000 积分", "适合体验"], recommended: false },
  { id: "pack-standard", code: "standard",   name: "标准包",  credits: 10_000,   priceCents: 89_900,   highlights: ["10,000 积分", "性价比之选"], recommended: true },
  { id: "pack-pro",      code: "pro",        name: "专业包",  credits: 50_000,   priceCents: 399_900,  highlights: ["50,000 积分", "重度创作"], recommended: false },
  { id: "pack-ent",      code: "enterprise", name: "企业包",  credits: 500_000,  priceCents: 3_499_900, highlights: ["500,000 积分", "团队/机构使用"], recommended: false },
];
