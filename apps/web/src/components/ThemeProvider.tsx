...
export const themeConfig = {
  ...
  neon: {
    name: { zh: '霓虹烈焰', en: 'Neon Blaze' },
    description: { zh: '高饱和荧光+热力光效+脉冲边框', en: 'High-saturation fluorescent + Hot glow + Pulsing' },
    sidebar: {
      bg: 'bg-[#0a0008]',
      itemBase: 'text-orange-300/60 hover:bg-orange-500/5 hover:text-orange-300',
      itemActive: 'bg-gradient-to-r from-pink-600/20 to-orange-500/20 text-orange-300 shadow-[0_0_25px_rgba(249,115,22,0.3)] border border-orange-500/30',
      sectionTitle: 'text-pink-500/50',
      border: 'border-pink-500/15',
      glow: 'shadow-[0_0_15px_rgba(236,72,153,0.4)]'
    }
  },
  ocean: {
    name: { zh: '深海幽蓝', en: 'Ocean Deep' },
    description: { zh: '深海蓝+水波光影+生物荧光', en: 'Deep sea blue + Ripple light + Bioluminescent' },
    sidebar: {
      bg: 'bg-gradient-to-b from-[#020617] to-[#0c1929]',
      itemBase: 'text-sky-400/50 hover:bg-sky-500/5 hover:text-sky-300',
      itemActive: 'bg-sky-500/10 text-sky-300 shadow-[0_0_20px_rgba(14,165,233,0.25)] border border-sky-500/20',
      sectionTitle: 'text-sky-600/40',
