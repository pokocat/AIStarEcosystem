...
export const SCRIPT_ASSETS: ScriptAsset[] = [
  {
    ...
    blocks: [
      { kind: "hook", label: "黄金 3s 钩子", dur: 3, text: "修了 30 年车，第一次给老婆买这个", shot: "修了30年车 · 第一次给老婆买" },
      { kind: "emotion", label: "故事铺垫", dur: 9, text: "修车场景 · 收摊回家 · 老婆揉脖子", shot: "她颈椎不好好多年了" },
      { kind: "product", label: "产品揭示", dur: 13, text: "从口袋拿出按摩仪 · 老婆惊讶反应", shot: "这是给你的" },
      { kind: "effect", label: "使用过程", dur: 10, text: "使用 + 老婆“舒服死了” + 笑场", shot: "她说：舒服死了" },
      { kind: "cta", label: "行动召唤", dur: 6, text: "“老婆说有需要的姐妹评论区扣 1”", shot: "有需要的姐妹评论区扣1" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "黄金 3s 钩子", dur: 3, text: "我妈用了这瓶精华，被亲戚以为是我姐", shot: "你猜我妈多大？" },
      { kind: "scene", label: "人物展示", dur: 5, text: "母亲皮肤特写 · 字幕“52 岁”", shot: "今年52岁" },
      { kind: "product", label: "产品引入", dur: 10, text: "从化妆台拿起精华瓶 · 镜头怼瓶身 30 帧", shot: "秘密就是它" },
      { kind: "effect", label: "效果展示", dur: 7, text: "使用前后对比 · 三周时间轴", shot: "用了三周 · 前后对比" },
      { kind: "cta", label: "行动召唤", dur: 3, text: "“链接放购物车了” + 字幕飘屏", shot: "链接在购物车" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "黄金 3s 钩子", dur: 3, text: "为什么我吃完早餐 11 点就饿？", shot: "11点就饿，为什么？" },
      { kind: "scene", label: "场景搭建", dur: 7, text: "厨房 vlog 视角 · 烧水 · 倒燕麦", shot: "5分钟搞定早餐" },
      { kind: "product", label: "产品融入", dur: 12, text: "产品袋特写 4 次 · 强调“低糖”标签", shot: "0蔗糖 · 高纤维" },
      { kind: "effect", label: "使用展示", dur: 8, text: "撕开倒入 · 加奶搅拌 · 第一口", shot: "饱腹一上午" },
      { kind: "cta", label: "CTA", dur: 2, text: "“评论区扣早 + 链接放小黄车”", shot: "链接在小黄车" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "身材钩子", dur: 3, text: "160 微胖姐妹，这件打底救我一命", shot: "160/68 微胖姐妹" },
      { kind: "scene", label: "痛点", dur: 5, text: "展示其他打底显胖 · 翻白眼", shot: "别的打底太显胖" },
      { kind: "product", label: "产品上身", dur: 8, text: "穿上德绒打底 · 转圈展示 · 弹幕“绝”", shot: "德绒发热不臃肿" },
      { kind: "cta", label: "价格 + CTA", dur: 6, text: "“69 块钱姐妹冲” + 链接动画", shot: "69元 · 姐妹冲" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "主播喊麦", dur: 3, text: "“今天 229 抢 50 台！”", shot: "229抢50台" },
      { kind: "product", label: "产品演示", dur: 10, text: "助理拆封演示 · 主播口播卖点 4 条", shot: "热敷+按摩双模" },
      { kind: "effect", label: "现场体验", dur: 8, text: "观众试用 · 弹幕实时反馈“信她”", shot: "现场试用" },
      { kind: "scene", label: "紧迫氛围", dur: 6, text: "“还剩 12 单！姐妹快冲！”", shot: "仅剩12单" },
      { kind: "cta", label: "CTA", dur: 3, text: "小黄车自取 · “抢完拉黑下一波”", shot: "小黄车自取" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "黄金 3s 钩子", dur: 3, text: "我爸 50 岁，第一次悄悄给我妈下单了这个", shot: "我爸50岁 · 第一次下单" },
      { kind: "emotion", label: "情感铺垫", dur: 8, text: "闺女躲门后偷拍 · 爸爸的手指划过价格", shot: "他犹豫了很久" },
      { kind: "product", label: "产品揭示", dur: 11, text: "快递到家 · 妈妈拆出按摩仪愣住", shot: "妈妈愣住了" },
      { kind: "effect", label: "效果体验", dur: 10, text: "妈妈戴上 · 爸爸偷笑 · 闺女字幕“破防了”", shot: "破防了" },
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "冲突钩子", dur: 4, text: "“同桌偷看我抽屉，发现了一个秘密”", shot: "他发现了我的秘密" },
      { kind: "scene", label: "场景铺垫", dur: 15, text: "教室场景 · 上课偷传纸条", shot: "上课偷传纸条" },
      { kind: "product", label: "产品出现", dur: 18, text: "产品作为道具自然融入剧情", shot: "秘密就是它" },
      { kind: "effect", label: "剧情高潮", dur: 18, text: "反转 + 同桌反应", shot: "结局没想到吧" },
      { kind: "cta", label: "CTA", dur: 5, text: "“下集预告 + 求关注”", shot: "关注看下集" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "反差钩子", dur: 3, text: "“年龄/身份反差 · 引发好奇”", shot: "你绝对想不到" },
      { kind: "scene", label: "人物展示", dur: 6, text: "场景化人物背景", shot: "她的故事" },
      { kind: "product", label: "产品引入", dur: 10, text: "产品作为关键道具", shot: "关键就在这" },
      { kind: "effect", label: "效果对比", dur: 8, text: "使用前后对比", shot: "前后对比" },
      { kind: "cta", label: "CTA", dur: 3, text: "“链接 + 行动召唤”", shot: "链接在下方" },
    ],
  ...
  },
  {
    ...
    blocks: [
      { kind: "hook", label: "黄金 3s 钩子", dur: 3, text: "蓝领老公给老婆买礼物，全村都馋哭了", shot: "全村都馋哭了" },
      { kind: "emotion", label: "情感铺垫", dur: 10, text: "工地下班顺手买", shot: "下班顺手买的" },
      { kind: "product", label: "产品揭示", dur: 12, text: "产品特写", shot: "就是这个" },
      { kind: "effect", label: "使用", dur: 8, text: "老婆使用反应", shot: "她超喜欢" },
      { kind: "cta", label: "CTA", dur: 5, text: "“评论区扣 1”", shot: "评论区扣1" },
    ],
