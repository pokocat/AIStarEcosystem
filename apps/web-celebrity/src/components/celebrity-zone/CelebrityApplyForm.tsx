...
export function CelebrityApplyForm({ star }: Props) {
  ...
  if (submitted) {
    return (
      <div className="mx-auto flex max-w-xl flex-col items-center gap-4 rounded-2xl border border-emerald-400/30 bg-emerald-500/[0.06] px-8 py-12 text-center">
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center gap-4 rounded-2xl border border-violet-400/20 bg-gradient-to-r from-violet-500/[0.06] to-violet-500/[0.06] p-5">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-emerald-400/30 bg-emerald-500/10 px-3 py-2 text-xs text-emerald-200">
      ...
      >
        ...
        <Field label="月预算">
          ...
          >
            <option value="" className="bg-[#0a0a14]">请选择…</option>
            <option value="lt-5k" className="bg-[#0a0a14]">5,000 元以内</option>
            <option value="5k-2w" className="bg-[#0a0a14]">5,000 - 20,000 元</option>
            <option value="2w-10w" className="bg-[#0a0a14]">20,000 - 100,000 元</option>
            <option value="gt-10w" className="bg-[#0a0a14]">100,000 元以上</option>
          </select>
        </Field>
