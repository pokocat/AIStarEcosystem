...
export function CelebrityGenerationProgress({
  ...
  if (minimized) {
    return (
      <button
        ...
        className="generation-progress-float fixed bottom-6 right-6 z-50 inline-flex items-center gap-2 rounded-full border border-violet-400/40 bg-white/95 px-4 py-2 text-xs text-violet-700 shadow-[var(--shadow-pop)] backdrop-blur transition hover:border-violet-500"
      >
  ...
  return (
    <div className="generation-progress-float fixed bottom-6 right-6 z-50 w-[360px] max-w-[95vw] overflow-hidden rounded-2xl border border-violet-400/30 bg-white/95 shadow-[var(--shadow-pop)] backdrop-blur">
      {/* 顶部光效 */}
