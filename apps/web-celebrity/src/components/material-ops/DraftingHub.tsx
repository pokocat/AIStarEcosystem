...
function AssetRow({ asset, active, onClick }: { asset: ScriptAsset; active: boolean; onClick: () => void }) {
  ...
  return (
    <button onClick={onClick} style={{ width: "100%", textAlign: "left", padding: "12px 16px", cursor: "pointer", borderBottom: "1px solid var(--line)", borderLeft: active ? "2px solid var(--accent)" : "2px solid transparent", background: active ? hexA("#7c5cff", "12") : "transparent", display: "flex", gap: 12, fontFamily: "var(--font-sans)" }}>
    ...
    <>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "18px 24px", display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div style={{ padding: "12px 14px", borderRadius: "var(--radius-md)", background: "var(--bg-2)", border: "1px dashed var(--line-2)" }}>
          <Eyebrow style={{ marginBottom: 8 }}>脚本卡片 · 存了什么</Eyebrow>
      ...
      <div style={{ width: 440, borderRight: "1px solid var(--line)", display: "flex", flexDirection: "column", minHeight: 0 }}>
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          {list.map((h) => {
            ...
            return (
              <button key={h.id} onClick={() => setSelectedId(h.id)} style={{ width: "100%", textAlign: "left", padding: "12px 16px", cursor: "pointer", borderBottom: "1px solid var(--line)", borderLeft: active ? "2px solid var(--danger)" : "2px solid transparent", background: active ? hexA("#ff5b8a", "0d") : "transparent", display: "flex", gap: 12, fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ width: 380, borderRight: "1px solid var(--line)", display: "flex", flexDirection: "column", minHeight: 0 }}>
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          {candidates.map((c, i) => {
            ...
            return (
              <button key={c.id} onClick={() => setPreviewId(c.id)} style={{ width: "100%", textAlign: "left", padding: "12px 16px", cursor: "pointer", borderBottom: "1px solid var(--line)", borderLeft: isP ? "2px solid var(--extra-teal)" : "2px solid transparent", background: isP ? hexA("#22b59a", "0d") : "transparent", fontFamily: "var(--font-sans)" }}>
