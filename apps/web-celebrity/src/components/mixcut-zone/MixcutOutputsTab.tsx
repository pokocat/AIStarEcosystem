      ...
      <div className="relative aspect-[4/5] bg-secondary/40">
        ...
        {canDelete && (
          <button
            ...
            disabled={deleting}
            title="删除视频"
            className="mobile-icon-target absolute bottom-1 left-1 inline-flex size-7 items-center justify-center rounded-md bg-black/65 text-white transition-colors hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-60"
          >
